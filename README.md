...
Rizzo, A. (2025). *HolographiX: a percept-first codec and network substrate for Large Vision Models and Large Audio Models over UDP (v1.0.1).* Zenodo. (v1.0.1). [10.5281/zenodo.17844824](https://zenodo.org/records/17844824)(https://doi.org/10.5281/zenodo.17860732))
