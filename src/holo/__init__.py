...
try:
    from .tnc import AFSKModem  # type: ignore
except Exception:  # pragma: no cover
    class AFSKModem:
        def __init__(self, *args, **kwargs):
            raise NotImplementedError("TNC is work in progress (tnc/ not present yet)")

try:
    from .tv import HoloTVWindow, HoloTVFrame, HoloTVReceiver, frame_content_id  # type: ignore
except Exception:  # pragma: no cover
    class HoloTVWindow:
        def __init__(self, *args, **kwargs):
            raise NotImplementedError("HoloTV is work in progress (tv/ not present yet)")
    ...
    def frame_content_id(*args, **kwargs):
        raise NotImplementedError("HoloTV is work in progress (tv/ not present yet)")
